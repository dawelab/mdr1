...
bin_start = -3000 #start position of first bin relative to edge position of feature. "W22_Gypsy_intact-" means upstream. Inclusive.
bin_end = 1499 #end position of last bin relative to edge of feature. "-" means upstream. Inclusive.
...
#Which end?
upstream_edge = True #Indicates which edge of feature defines bins
